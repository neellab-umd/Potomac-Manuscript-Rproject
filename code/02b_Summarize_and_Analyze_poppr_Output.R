...
# In this section we count the number of stems per MLG from the original source data file and calculate how many are single- versus multi-stemmed overall and in each tidal regime. 
...
RiverKm <- readr::read_csv(here("data","RiverKm.csv"))
